...
document.addEventListener("DOMContentLoaded", function () {
	...
	if (window.matchMedia(lgScreen).matches) {
		...
		animateTextFromRight.forEach((item) => {
			...
			animateTextFromRightSplitted.split({
				type: "words"
			});
		...
		animateTextFromLeft.forEach((item) => {
			...
			animateTextFromLeftSplitted.split({
				type: "words"
			});
		...
		animateTextFromBottom.forEach((item) => {
			...
			animateTextFromBottomSplitted.split({
				type: "words"
			});
		...
		animateTextFromTop.forEach((item) => {
			...
			animateTextFromTopSplitted.split({
				type: "words"
			});
		...
		fadeIn(".subtitle_line_1", {
			opacity: 0,
			x: -80
		}, {
			stagger: 0.15
		});
		fadeIn(".subtitle_line_2", {
			opacity: 0,
			x: -80
		}, {
			stagger: 0.15
		});
		fadeIn(".subtitle_line_3", {
			opacity: 0,
			x: -80
		}, {
			stagger: 0.15
		});
		fadeIn(".subtitle_line_4", {
			opacity: 0,
			x: 80
		}, {
			stagger: 0.15
		});
		fadeIn(".subtitle_line_5", {
			opacity: 0,
			x: -80
		}, {
			stagger: 0.15
		});
		fadeIn(".subtitle_line_6", {
			opacity: 0,
			x: -80
		}, {
			stagger: 0.15
		});
		fadeIn(".subtitle_line_7", {
			opacity: 0,
			x: -80
		}, {
			stagger: 0.15
		});
		fadeIn(".welcome-list-1", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.15
		});
		fadeIn(".fadein_bottom_1", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.15
		});
		fadeIn(".fadein_bottom_2", {
			opacity: 0,
			y: 80
		}, {
			stagger: 0.15
		});
		fadeIn(".fadein_bottom_3", {
			opacity: 0,
			y: 80
		}, {
			stagger: 0.15
		});
		fadeIn(".fadein_bottom_4", {
			opacity: 0,
			y: 80
		}, {
			stagger: 0.15
		});
		fadeIn(".fadein_bottom_5", {
			opacity: 0,
			y: 80
		}, {
			stagger: 0.15
		});
		fadeIn(".fadein_bottom_6", {
			opacity: 0,
			y: 80
		}, {
			stagger: 0.15
		});
		fadeIn(".fadein_bottom_7", {
			opacity: 0,
			y: 80
		}, {
			stagger: 0.15
		});
		fadeIn(".fadein_bottom_8", {
			opacity: 0,
			y: 100
		}, {
			stagger: 0.25
		});
		fadeIn(".fadein_bottom_9", {
			opacity: 0,
			y: 100
		}, {
			stagger: 0.25
		});
		fadeIn(".fadein_bottom_10", {
			opacity: 0,
			y: 100
		}, {
			stagger: 0.25
		});
		fadeIn(".fadein_bottom_11", {
			opacity: 0,
			y: 100
		}, {
			stagger: 0.25
		});
		fadeIn(".fadein_bottom_12", {
			opacity: 0,
			y: 100,
			duration: 3,
			delay: 0.5
		...
		fadeIn(".fadein_bottom_13", {
			opacity: 0,
			y: 100
		}, {
			stagger: 0.25
		});
		fadeIn(".fadein_bottom_14", {
			opacity: 0,
			y: 100
		}, {
			stagger: 0.25
		});
		fadeIn(".fadein_bottom_15", {
			opacity: 0,
			y: 100
		}, {
			stagger: 0.25
		});
		fadeIn(".fadein_bottom_16", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.25
		});
		fadeIn(".fadein_bottom_17", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.25
		});
		fadeIn(".fadein_bottom_18", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.25
		});
		fadeIn(".fadein_bottom_19", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.25
		});
		fadeIn(".fadein_bottom_20", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.25
		});
		fadeIn(".fadein_bottom_21", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.25
		});
		fadeIn(".fadein_bottom_22", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.25
		});
		fadeIn(".fadein_bottom_23", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.25
		});
		fadeIn(".fadein_bottom_24", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.25
		});
		fadeIn(".fadein_bottom_25", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.25
		});
		fadeIn(".fadein_bottom_26", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.25
		});
		fadeIn(".fadein_bottom_27", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.15
		});
		fadeIn(".fadein_bottom_28", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.15
		});
		fadeIn(".fadein_bottom_29", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.15
		});
		fadeIn(".fadein_bottom_30", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.15
		});
		fadeIn(".fadein_bottom_31", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.15
		});
		fadeIn(".fadein_bottom_32", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.25
		});
		fadeIn(".fadein_bottom_33", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.15
		});
		fadeIn(".fadein_bottom_34", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.15
		});
		fadeIn(".fadein_bottom_35", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.25
		});
		fadeIn(".fadein_bottom_36", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.25
		});
		fadeIn(".fadein_bottom_37", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.25
		});
		fadeIn(".fadein_bottom_38", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.25
		});
		fadeIn(".fadein_bottom_39", {
			opacity: 0,
			y: 50
		}, {
			stagger: 0.25
		...
		heroOne.forEach((element) => {
			...
			tl.fromTo(".hero-1-shapes__img--5", {
				y: 0
			}, {
				y: 50,
				yoyo: true,
			...
			tl.fromTo(".hero-1-shapes__img--6", {
				y: 0
			}, {
				y: 20,
				yoyo: true,
